...
var linkTemplate = doT.template('<a href=[[=locals.url]]>[[=locals.text]]</a>');
var scriptTemplate = doT.template('<script src=[[=locals.src]]></script>');
var cssLinkTemplate = doT.template('<link href=[[=locals.href]] rel="stylesheet">');

module.exports = function () {

  var _helpers = {};

  //these helper functions were directly copied from HBS helpers
  //part of them may not be needed
  ...
  * */
  ...
  _helpers.getKeystoneAttr = function (attrKey) {
    return keystone.get(attrKey);
  }

  _helpers.exposeLocals = function (locals) {
    return JSON.stringify(locals);
  }

  _helpers.testHelper = function() {
