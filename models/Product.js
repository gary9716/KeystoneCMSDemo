...
ProductType.add({
  name: { type: String, label: '類別名', index: true, require: true, initial: true }
});
...
Product.add({
  pid: { type: String, label: '商品編號', require: true, index: true, initial: true },
  name: { type: String, label: '商品名', require: true, index: true, initial: true },
  pType: { type: Types.Relationship, label: '商品類型', ref: Constants.ProductTypeListName, require: true, index: true, initial: true },
  marketPrice: { type: Types.Money, label: '牌價', require: true, initial: true },
