...
Purchase.add({
  ...
  startDate: { type: Types.Date, label: '期別開始', initial: true, index: true },
  endDate: { type: Types.Date, label: '期別結束', initial: true, index: true },
  priceDate: { type: Types.Date, label: '定價日期', initial: true, required: true, index: true },
